...
public class ControllerLogin
{
	...
	{
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/WQClient/FXML/Register2.fxml"));
	...
	public void goToChallenge(ActionEvent event, String word) throws Exception
	{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/WQClient/FXML/challenge.fxml"));
	...
	public void goToScore(ActionEvent event, int score, String eventChallenge) throws Exception
	{
		...
		FXMLLoader loader = new FXMLLoader(getClass().getResource("/WQClient/FXML/score.fxml"));
		Parent home = loader.load();
		ScoreController c = loader.getController();
		
		if (eventChallenge != null)
		{
			if (eventChallenge.startsWith("460"))
			{
				c.setText(eventChallenge.substring(4));
				c.disableGotohome();
				stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
